 ...
 */
@Service
public class BuyHistoryServiceIm implements BuyHistoryService {
	
	protected Log log = LogFactory.getLog(this.getClass());
	

	@Autowired
	private BuyHistoryDao wsDao;
	...
	public JSONObject UpdateRequest(HashMap<String, Object> params) throws Exception {
		...
		if(params != null) {
			...
			String symbol = null;
			if(params.containsKey("symbol") == true) symbol = params.get("symbol").toString();
			HashMap<String, Object> subparams = new HashMap<String, Object>();
			subparams.put("IDX", idx);
			subparams.put("SYMBOL", symbol);
			HashMap<String, Object> reqmap = null;
			reqmap = wsDao.selectone(subparams);		
			if(reqmap != null) {
